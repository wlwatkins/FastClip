...
The refactor is divided into twelve work packages. A work package is the unit
...
| [07](./wp-07-encryption.md) | Encryption and migration | 03 | backend-dev |
| [08](./wp-08-tray.md) | Tray icon | 05 | backend-dev |
| [09](./wp-09-export-import.md) | Export and import | 07 | both devs |
...
ratified, and WP-07, WP-08 and WP-10 once their dependencies clear.
