...
interface ContextMenuContext {
  lastEventRef: React.RefObject<React.MouseEvent | null>;
...
const RefWrapper = forwardRef<HTMLElement, RefWrapperProps>(
  (props, ref) => {
    ...
    if (!React.isValidElement(children)) {
      throw new Error('ContextMenu.Target children must be a valid React element.');
    }
    ...
    const elementChildren = children as React.ReactElement<any>;

    const onContextMenu = createEventHandler(
      elementChildren.props.onContextMenu,
      (e) => {
    ...
    return cloneElement(elementChildren, {
      ...others,
      onClick,
      onContextMenu,
      [refProp]: ref,
